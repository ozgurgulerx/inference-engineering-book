...
::: {.book-landing}
![](assets/cover.svg){.book-cover fig-alt="Inference Engineering book cover showing the stack from data center design to production LLM systems."}

::: {.book-landing-copy}
<p class="book-kicker">Systems book</p>

Inference engineering is the applied discipline of making model execution work
inside real systems.

<p class="book-deck">This book follows the path from power, cooling, racks, and
networks to hardware architecture, transformer mechanics, kernels, serving
runtimes, benchmarks, and production operations.</p>
:::
:::
